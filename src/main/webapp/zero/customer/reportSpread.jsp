...
<script type="text/javascript" src="./reportSpread.js"></script>

</head>
<body>
<div class="easyui-layout" data-options="fit:true">
	<div id="customer-toolbar-inp-1">
	...
	<div class="easyui-layout" data-options="fit:true">
		<table id="report-datagrid-inp" class="easyui-datagrid" toolbar="#customer-toolbar-inp-1">
		</table>
	</div>
</div>  
