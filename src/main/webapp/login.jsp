...
<div class="login" style="margin-top:50px;">
    ...
    <div class="web_qr_login" id="web_qr_login" style="display: block; height: 235px;">
			...
			<div class="login_form">
				<form action="${pageContext.request.contextPath}/shiro/login" name="loginform" accept-charset="utf-8" id="login_form" class="loginForm" method="post"><input type="hidden" name="did" value="0"/>
               <input type="hidden" name="to" value="log"/>
                <div class="uinArea" id="uinArea">
                <label class="input-tips" for="u">帐号：</label>
                <div class="inputOuter" id="uArea">
                    
                    <input type="text" id="u" name="fdLoginName" class="inputstyle"/>
                </div>
                </div>
               ...
               <div class="inputOuter" id="pArea">
                    ...
                    <input type="password" id="p" name="fdPassword" class="inputstyle"/>
                </div>
                </div>
                    <div style="padding-left:80px;color:red"><strong><%=loginRes %></strong></div>
